/* start of combined JS file | start of fh-custom-script.js */
	...
	/* BEGINNING OF APP JS */
		...
		var getProductGroup = function(productID) {
			...
			switch(productID) {
				...
				case 4347259682900:
				case 4347286585428:
					prodGroupJSON = [{"id":4347066581076,"title":"Kapow (Grey Twist)","handle":"kapow-grey-twist-mens-shoes","image":"https://cdn.shopify.com/s/files/1/0258/2485/4100/products/flatheads-mens-shoes-kapow-grey-twist-1.jpg?v=1576590358","sku":"FHMSH021901KAPOGYY06","name":"Grey Twist","type":"image","data":"grey-white-banana.png?v=1580325885"},{"id":4347172126804,"title":"Kapow (Black Origin)","handle":"kapow-black-origin-mens-shoes","image":"https://cdn.shopify.com/s/files/1/0258/2485/4100/products/flatheads-mens-shoes-kapow-black-origin-3.jpg?v=1576583166","sku":"FHMSH021901KAPOBLW06","name":"Black Origin","type":"image","data":"black-white.png?v=1580325885"},{"id":4347259682900,"title":"Kapow (Olive Origin)","handle":"kapow-olive-origin-mens-shoes","image":"https://cdn.shopify.com/s/files/1/0258/2485/4100/products/flatheads-mens-shoes-kapow-olive-origin-2.jpg?v=1576593887","sku":"FHMSH021901KAPOOLW06","name":"Olive Origin","type":"image","data":"olive-white.png?v=1580325885"},{"id":4347286585428,"title":"Kapow (Grey Origin)","handle":"kapow-grey-origin-mens-shoes","image":"https://cdn.shopify.com/s/files/1/0258/2485/4100/products/flatheads-mens-shoes-kapow-grey-origin-2.jpg?v=1576587591","sku":"FHMSH021901KAPOGYW06","name":"Grey Origin","type":"image","data":"grey-white.png?v=1580325885"}];
					break;
				case 4347388395604:
				case 4347438530644:
...
/* end of combined JS file | end of fh-custom-script.js */

/* start of combined JS file | start of fh-ucd-app.js?shop=flatheads.myshopify.com&v=1.1.2 */
                ...
                sellify.ucd.shop) {
                    ...
                    window.sellify.ucd.setSettings({
                        ...
                        "templates": {
                            ...
                            "discount_code_details": "{{#discount}} {{#if code}} <div class=\"ucd-footer-grid\"> <div class=\"ucd-foot-label\"> <p>{{@root.t.discount_code.discount}} <span class=\"sellify-ucd-discount-code\">({{code}})<\/span> <a href=\"javascript:\" class=\"remove-code sellify-ucd-remove-discount-code\"> <span>remove code</span> <\/a> <span id=\"customDiscountAppliedMsg\"></span><\/p> <\/div> <div class=\"ucd-foot-value\"> <p>-{{{formatted_amount}}}<\/p> <\/div> <\/div> {{\/if}} {{\/discount}}",
                        ...
                        "translations": {
                            "en": {
                                ...
                                "discount_code": {
                                    ...
                                    "fallback_error_message": "Something went wrong! Please refresh the page and try again. If the issue persists, contact us at rescue@flatheads.in"
                                },
                                "upsells": {
...
/* end of combined JS file | end of fh-ucd-app.js?shop=flatheads.myshopify.com&v=1.1.2 */


/* start of combined JS file | start of fh-shopify_discount_code.js */
...
! function(t) {
    ...
    "Y/jY": function(t, e, r) {
        ...
        function c(t) {
                        ...
                        for (;;) switch (r.prev = r.next) {
                            ...
                            case 7:
                                return e = (new Date).getTime(), sellify.ucd.discount = {}, t(".sellify-ucd-apply-discount-code").addClass("is-loading"), r.next = 12, fetch("/checkout?discount=".concat(n, "&t=").concat((new Date).getTime()), {
                                    ...
                                    i(t)
                                    if(n == 'FREETEE') {
                                    	$("#customDiscountAppliedMsg ").html("<br><span style='font-size: 14px; text-transform: none;'>+ FREE Bamboo T-shirt</span>");
                                    }
                                })).catch((function(e) {
            ...
            function i(e) {
                e = t(e), sellify.ucd.discount.error = $(e.find("#error-for-reduction_code")[0]).text() || e.find(".order-summary__section--discount .notice__content .notice__text").html() || e.find(".page-error__title").text() || e.find(".content--desc:nth(1)").text(), sellify.ucd.discount.error = "string" == typeof sellify.ucd.discount.error ? sellify.ucd.discount.error.trim() : sellify.ucd.discount.error;
                var r = $(e.find('[data-reduction-form="true"] .reduction-code__text')[0]).text(),
                ...
                } else sellify.ucd.discount.error = sellify.ucd.discount.error || sellify.ucd.get_translation("discount_code.fallback_error_message") || "Something went wrong! Please refresh the page and try again. If the issue persists, contact us at rescue@flatheads.in", sellify.ucd.helpers.cookie.write("_discount_code", "");
...
/* end of combined JS file | end of fh-shopify_discount_code.js */